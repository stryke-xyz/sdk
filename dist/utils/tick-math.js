...
exports.MAX_TICK_NUM = exports.MIN_TICK_NUM = exports.maxUint256 = void 0;
exports.getSqrtRatioAtTick = getSqrtRatioAtTick;
exports.maxUint256 = 2n ** 256n - 1n;
exports.MIN_TICK_NUM = -887272;
exports.MAX_TICK_NUM = -exports.MIN_TICK_NUM;
...
function getSqrtRatioAtTick(tick) {
    ...
    if (absTick > MAX_TICK)
        throw Error("T");
    let ratio = (absTick & BigInt("0x1")) != BigInt(0)
    ...
    if (tick > 0)
        ratio = exports.maxUint256 / ratio;
